...
namespace Tp4_huchani_ABM_DibuAventuras
{
    internal class Program
    {
        ...
        static string ModificarPersonaje(object[,] personajes)
        {
            ...
            {
                Console.Clear();
                MostrarEncabezado(); // Muestra los encabezados
                for (int i = 0; i < 20; i++)
                {
                    if (personajes[i, 0] != null)
                    {
                        MostrarPersonaje(personajes, i); // Muestra los personajes existentes
                    }
                }
            ...
            // Muestra los datos del personaje después de la modificación
            Console.Clear();
            MostrarEncabezado(); // Muestra los encabezados
            MostrarPersonaje(personajes, posicion); // Muestra el personaje modificado
            Console.WriteLine("\nPersonaje modificado exitosamente");
            Console.ReadKey();
